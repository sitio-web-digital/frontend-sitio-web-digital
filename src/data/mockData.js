...
export const SECTION_VARIANTS = {
  ...
  hero: [
    { id: 'centrado', label: 'Centrado', skeleton: 'centered' },
    { id: 'split', label: 'Imagen + texto', skeleton: 'split' },
  ...
  productos: [
    { id: 'grid-3', label: 'Filas de 3', skeleton: 'grid3col' },
    { id: 'grid-4', label: 'Filas de 4', skeleton: 'grid4col' },
    { id: 'grid-5', label: 'Filas de 5', skeleton: 'grid5col' },
    { id: 'lista', label: 'Lista', skeleton: 'productosLista' },
    { id: 'fila', label: 'Fila con foto', skeleton: 'productosFila' },
    { id: 'bento', label: 'Destacado + grilla', skeleton: 'productosBento' },
    { id: 'servicios', label: 'Servicios (sin foto)', skeleton: 'productosServicios' },
    { id: 'catalogo', label: 'Catálogo con filtro', skeleton: 'productosCatalogo' },
    { id: 'tarifario', label: 'Lista de precios', skeleton: 'productosTarifario' },
  ],
  'sobre-nosotros': [
    { id: 'split', label: 'Texto + datos', skeleton: 'split' },
    { id: 'centrado', label: 'Centrado', skeleton: 'aboutCentered' },
    { id: 'fondo', label: 'Imagen de fondo', skeleton: 'heroFondo' },
  ],
  footer: [
  ...
  beneficios: [{ id: 'fila', label: 'Fila con íconos', skeleton: 'beneficiosFila' }],
  ...
  zonas: [{ id: 'lista', label: 'Lista con tilde', skeleton: 'zonasLista' }],

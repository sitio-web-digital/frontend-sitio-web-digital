...
export const SECTION_VARIANTS = {
  ...
  categorias: [
    ...
    { id: 'catalogo', label: 'Título + grilla de fotos con nombre y conteo', skeleton: 'categoriasScroll' },
  ],
  pasos: [
    ...
    { id: 'consejos', label: 'Encabezado + fila de 4, borde superior de color', skeleton: 'pasosNumerados' },
  ],
  ...
  beneficios: [
    ...
    { id: 'raya', label: 'Franja con guión, sin ícono', skeleton: 'beneficiosFila' },
  ],
